...
if __name__ == "__main__":
    ...
    for i in range(len(target_list)):
        for panel in range(1, 4):
            ...
            #source2 = get_source(target_list[i], immuno_mapping, panel + 1, Path(args.source))
            if source is None:
            ...
            run_on_one(source, target, output_folder / (source.stem + "_reg2HE.tiff"))
            #run_on_one(target_list[i], source, output_folder / (source.stem + "_reg2HE.tiff"))
